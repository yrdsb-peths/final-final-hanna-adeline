...
This is a side-scrolling action game where the player controls a witch who battles monsters using attacks, flight, and cooldown mechanics while progressing through multiple levels.
